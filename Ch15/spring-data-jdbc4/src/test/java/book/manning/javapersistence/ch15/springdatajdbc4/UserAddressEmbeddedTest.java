package book.manning.javapersistence.ch15.springdatajdbc4;

import book.manning.javapersistence.ch15.springdatajdbc4.model.Address;
import book.manning.javapersistence.ch15.springdatajdbc4.model.User;
import book.manning.javapersistence.ch15.springdatajdbc4.repositories.UserAddressEmbeddedRepository;
...
class UserAddressEmbeddedTest {
    ...
    @Test
    void embeddedTest() {
        User mike = userAddressEmbeddedRepository.findByUsername("mike");
        assertAll(
                () -> assertThat(mike).isNotNull(),
                () -> assertThat(mike.getAddress()).isNotNull(),
                () -> assertThat(mike.getAddress().getCity()).isEqualTo("New York")
        );
    }
